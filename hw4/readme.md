1. Запрограмувати алгоритм пошуку еліпса  по 6+ точках. Побудувати графік, як залежить максимальне відхилення знайденого еліпса від очікуваного від нормально розподіленої похибки у заданих точках.
